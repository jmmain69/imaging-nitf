...
public class PIAPEB_WrapTest extends SharedTreTestSupport {
	...
	public void testGettersAllSpaces() throws NitfFormatException {
		...
		if (piapeb == null) {
			...
			assertThat(LOGGER.getLoggingEvents(), is(Arrays.asList(LoggingEvent.debug(
					"Could not parse as a local date: Text '        ' could not be parsed at index 0"))));
